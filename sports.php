	...
	<div class="row">
        ...
        <?php
                  include "config.php"; // database configuration
                    $sql = "SELECT question, type_, qid, answer, OP2, OP3 ,OP4 FROM qna WHERE type_ = 2";
    		...
    		<table class="table table-condensed table-hover">
                ...
                <?php
    				...
    				<tr>
    					...
    					<td> <form class="search-post" action='answer-saveS.php?qtype=<?php echo $row["type_"]; ?>&quesid=<?php echo $row['qid']; ?>'method ="POST">
    				...
    				<tr>
    					...
    					<td><a class="btn btn-success" href="history.php"><i class=" icon-white"></i>History Quiz</a></td>
    				</tr>
    			</tbody>
    		</table>
            <?php
